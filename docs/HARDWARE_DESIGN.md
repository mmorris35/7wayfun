...
📐 **Interactive Diagrams**: All circuit diagrams are available in the [`diagrams/`](diagrams/) directory and viewable directly in GitHub.

- **[System Architecture](diagrams/system_architecture.md)** - High-level Mermaid block diagram showing complete system
- **[Voltage Divider Circuit](diagrams/voltage_divider.svg)** - Input voltage scaling (12V → 3.3V)
- **[Power Supply](diagrams/power_supply.svg)** - 12V to 5V/3.3V power conversion
- **[I2C Bus Topology](diagrams/i2c_bus.svg)** - ADCs and OLED display connections
- **[Relay Driver Circuit](diagrams/relay_outputs.svg)** - Output relay configuration
- **[7-Way Connector Pinout](diagrams/connector_pinout.svg)** - RV 7-Way Standard pin assignments

> **Note**: Schemdraw diagrams can be regenerated by running `python3 docs/diagrams/generate_diagrams.py`
...
| 3   | Tail/Running Lights   | Green      | 12V when headlights on         |
| 4   | Left Turn/Brake       | Red        | 12V pulsed or steady           |
| 5   | Right Turn/Brake      | Brown      | 12V pulsed or steady           |
| 6   | 12V Auxiliary/Charge  | Black      | 12V-14.4V continuous           |
| 7   | Reverse Lights        | Yellow     | 12V when in reverse            |
...
| D9   | Relay 2 (Tail)        | Green wire                          |
| D10  | Relay 3 (Left Turn)   | Red wire                            |
| D11  | Relay 4 (Right Turn)  | Brown wire                          |
| D12  | Relay 5 (Aux 12V)     | Black wire                          |
| D13  | Relay 6 (Reverse)     | Yellow wire                         |
...
| 2     | Tail/Running | Dim green   | Bright grn  | Red         |
| 3     | Left Turn    | Dim red     | Bright red  | Red         |
| 4     | Right Turn   | Dim brown   | Bright brwn | Red         |
| 5     | Aux 12V      | Dim white   | Bright wht  | Red blink   |
| 6     | Reverse      | Dim yellow  | Bright yel  | Red         |
